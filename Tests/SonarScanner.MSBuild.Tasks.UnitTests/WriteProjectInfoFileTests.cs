...
namespace SonarScanner.MSBuild.Tasks.UnitTests
{
    ...
    public class WriteProjectInfoFileTests
    {
        ...
        private void AssertProjectGuidIsRandomlyGenerated(string projectGuid, string solutionConfigurationContents)
        {
